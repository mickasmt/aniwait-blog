...
function BannerHomepage() {
  ...
  return (
    <section>
      <div className="relative bg-slate-100 dark:bg-slate-900 overflow-hidden py-24">
        <div className="relative z-20 container m-auto px-6 md:px-12">
          <div className="m-auto text-center space-y-8 lg:w-10/12 xl:w-8/12">
            ...
            <div className="pt-10 flex justify-center space-x-6 font-semibold tracking-wide">
