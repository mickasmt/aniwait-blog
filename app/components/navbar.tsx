...
function Navbar() {
  ...
  return (
    <header className="flex h-12 sm:h-14 border-b border-gray-200 sticky top-0 backdrop-blur-md z-50 text-black bg-white/80 dark:bg-slate-900/90 dark:border-gray-800 dark:text-slate-100 dark:backdrop-blur-xl">
