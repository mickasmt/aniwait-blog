...
function Navbar() {
  ...
  return (
    <header className="flex h-12 border-b border-gray-200 sticky top-0 backdrop-blur-md z-50 text-black sm:h-14 bg-white/80 dark:bg-gray-900/90 dark:border-gray-800 dark:text-gray-100 dark:backdrop-blur-xl">
